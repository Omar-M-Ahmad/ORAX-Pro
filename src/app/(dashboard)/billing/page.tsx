...
export default function BillingPage(): React.JSX.Element {
  ...
  const price = subscription?.price ?? 99;
    ...
    subscription
      ? {
          ...
          date: subscription.currentPeriodEnd
            ? new Date(subscription.currentPeriodEnd).toLocaleDateString(l, {
                year: "numeric",
                month: "short",
                day: "numeric",
              })
      ...
      >
        ...
        >
          <div>
            ...
            >
              ...
              <span
                style={{
                  ...
                  color: status === "active" ? "var(--green)" : "var(--amber)",
                  border:
                    status === "active"
            ...
            >
              {loading ? "Loading..." : t("billing.period", l)}
            </p>
